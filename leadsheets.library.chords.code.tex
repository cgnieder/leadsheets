\LeadsheetsExplLibrary{chords}{2015/05/08 printing chords}
...
\keys_define:nn {leadsheets}
  {
    ...
    chordnames/output-notation .choice: ,
    chordnames/output-notation/german  .code:n =
      \bool_set_true:N \l__leadsheets_output_notation_german_bool ,
    chordnames/output-notation/english .code:n =
      \bool_set_false:N \l__leadsheets_output_notation_german_bool ,
    chordnames/input-notation .choice: ,
    chordnames/input-notation/german   .code:n =
      \bool_set_true:N \l__leadsheets_input_notation_german_bool ,
    chordnames/input-notation/english  .code:n =
...
2015/05/08 - input/output notation is done here now instead of in the
             `chordnames' library so transposing works with either input
             correctly
           - options `input-notation' and `output-notation' now directly
             belong to leadsheets and not to the `chordnames' library
             anymore.
