...
\tl_new:N \l__leadsheets_no_five_tl
...
\tl_set:Nn \l__leadsheets_no_five_tl     {\textsuperscript{no5}}
...
\cs_gset_protected:Npn \leadsheets_chord_aux:n !1
 {
    ...
    \leadsheets_chord_sym:NnV  \l__leadsheets_chord_tl {no5} \l__leadsheets_no_five_tl
...
\keys_define:nn {leadsheets/chords}
  {
    ...
    no-five      .tl_set:N = \l__leadsheets_no_five_tl ,
